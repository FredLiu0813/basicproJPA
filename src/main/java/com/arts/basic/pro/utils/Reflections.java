...
public class Reflections {
	...
	public static Object getFieldValue(final Object obj, final String fieldName) {
		...
		if (field == null) {
			...
			sBuilder.append("Could not find field [");
			sBuilder.append(fieldName);
			sBuilder.append("] on target [");
			sBuilder.append(obj);
			sBuilder.append("]");
	...
	public static Object invokeMethod(final Object obj, final String methodName, final Class<?>[] parameterTypes,
		...
		if (method == null) {
			StringBuilder sBuilder = new StringBuilder();
			sBuilder.append("Could not find method [");
	...
	public static Class getClassGenricType(final Class clazz, final int index) {
		...
		if ((index >= params.length) || (index < 0)) {
			...
			sBuilder.append(index);
			sBuilder.append(", Size of ");
			sBuilder.append(clazz.getSimpleName());
			sBuilder.append("'s Parameterized Type: ");
			sBuilder.append(params.length);
